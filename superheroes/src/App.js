...
const heroes = [
    ...
    },
    {
        ...
        universe: "DC Comics",
        alterEgo: "Кларк Кент",
        occupation: "борец с преступностью",
...
function App() {
    return (
        <>
            {heroes.map((card) => (
                <Card
                    data={{ name: card.name, universe: card.universe, alterEgo: card.alterEgo, friends: card.friends, superpowers: card.superpowers, src: card.src, description: card.description }}
                    name={card.name}
